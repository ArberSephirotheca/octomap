...
namespace binary_radix_tree
{
	...
	template <typename T>
	inline int delta(const std::vector<T>& morton_keys, const int& i, const int& j)
	{
	...
	inline int delta_safe(const int key_num, const std::vector<uint32_t>& morton_keys, const int& i, const int& j)
	{
	...
	void process_internal_node(const int key_num, const std::vector<uint32_t>& morton_keys, const int i, binary_radix_tree::brt& brt)
	{
...
binary_radix_tree::brt binary_radix_tree::create(const int key_num, const std::vector<uint32_t>& morton_keys)
{
...
/** given a sorted sequence of morton_keys, create a binary radix tree. */
binary_radix_tree::brt binary_radix_tree::create_threaded(const int key_num, const std::vector<uint32_t>& morton_keys, const int thread_number)
{
	// initialize the memory to hold the tree
	binary_radix_tree::brt tree(key_num);
