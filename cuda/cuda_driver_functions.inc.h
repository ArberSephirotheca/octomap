...
PER_CUDA_FUNCTION(device_get_attribute, cuDeviceGetAttribute, int *, uint32_t, void *);
...
// Stream management
PER_CUDA_FUNCTION(stream_create, cuStreamCreate, void **, uint32_t);
...
PER_CUDA_FUNCTION(malloc_managed, cuMemAllocManaged, void **, std::size_t, uint32_t);
PER_CUDA_FUNCTION(memset, cuMemsetD8_v2, void *, uint8_t, std::size_t);
PER_CUDA_FUNCTION(memsetd32, cuMemsetD32_v2, void *, uint32_t, std::size_t);
PER_CUDA_FUNCTION(mem_free, cuMemFree_v2, void *);
PER_CUDA_FUNCTION(mem_free_async_impl, cuMemFreeAsync, void *, void *);
PER_CUDA_FUNCTION(mem_advise, cuMemAdvise, void *, std::size_t, uint32_t, uint32_t);
PER_CUDA_FUNCTION(mem_get_info, cuMemGetInfo_v2, std::size_t *, std::size_t *);
PER_CUDA_FUNCTION(mem_get_attribute, cuPointerGetAttribute, void *, uint32_t, void *);
PER_CUDA_FUNCTION(mem_pool_set_attribute, cuMemPoolSetAttribute, void *, uint32_t, void *);
...
PER_CUDA_FUNCTION(launch_kernel, cuLaunchKernel, void *, uint32_t, uint32_t, uint32_t,
                  uint32_t, uint32_t, uint32_t, uint32_t, void *, void **, void **);
PER_CUDA_FUNCTION(kernel_get_attribute, cuFuncGetAttribute, int *, uint32_t, void *);
...
// Event management
PER_CUDA_FUNCTION(event_create, cuEventCreate, void **, uint32_t)
