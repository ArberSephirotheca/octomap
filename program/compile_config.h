...
struct CompileConfig {
  ...
  */
  ...
  // The default size when the redwood compiler is unable to automatically
...
/*
extern RW_DLL_EXPORT CompileConfig default_compile_config;
*/
}  // namespace redwood::lang